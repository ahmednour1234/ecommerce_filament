...
return [
    'items' => [
        ...
        [
            'title' => 'sidebar.housing_department',
            'icon' => 'heroicon-o-home-modern',
            'url' => null,
            'permission' => null,
            'badge' => null,
            'children' => [
                [
                    'title' => 'sidebar.housing.recruitment_housing',
                    'icon' => 'heroicon-o-user-group',
                    'url' => null,
                    'permission' => null,
                    'badge' => null,
                    'children' => [
                        [
                            'title' => 'sidebar.housing.dashboard',
                            'icon' => 'heroicon-o-home',
                            'url' => fn() => \App\Filament\Pages\Housing\Recruitment\RecruitmentHousingDashboardPage::getUrl(),
                            'permission' => 'housing.dashboard.view',
                        ],
                        [
                            'title' => 'sidebar.housing.workers',
                            'icon' => 'heroicon-o-user-group',
                            'url' => fn() => \App\Filament\Pages\Housing\Recruitment\RecruitmentHousingWorkersPage::getUrl(),
                            'permission' => 'housing.workers.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.available_workers',
                            'icon' => 'heroicon-o-user-plus',
                            'url' => fn() => \App\Filament\Pages\Housing\Recruitment\RecruitmentHousingAvailableWorkersPage::getUrl(),
                            'permission' => 'housing.available_workers.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.requests',
                            'icon' => 'heroicon-o-clipboard-document-list',
                            'url' => fn() => \App\Filament\Resources\Housing\Recruitment\RecruitmentHousingRequestResource::getUrl(),
                            'permission' => 'housing.requests.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.salary_batches',
                            'icon' => 'heroicon-o-banknotes',
                            'url' => fn() => \App\Filament\Resources\Housing\Recruitment\RecruitmentHousingSalaryBatchResource::getUrl(),
                            'permission' => 'housing.salary_batches.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.salary_deductions',
                            'icon' => 'heroicon-o-minus-circle',
                            'url' => fn() => \App\Filament\Resources\Housing\Recruitment\RecruitmentHousingSalaryDeductionResource::getUrl(),
                            'permission' => 'housing.salary_deductions.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.leaves',
                            'icon' => 'heroicon-o-calendar-days',
                            'url' => fn() => \App\Filament\Resources\Housing\Recruitment\RecruitmentHousingLeaveResource::getUrl(),
                            'permission' => 'housing.leaves.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.reports',
                            'icon' => 'heroicon-o-chart-bar',
                ...
                [
                    'title' => 'sidebar.housing.rental_housing',
                    'icon' => 'heroicon-o-home-modern',
                    'url' => null,
                    'permission' => null,
                    'badge' => null,
                    'children' => [
                        ...
                        [
                            'title' => 'sidebar.housing.workers',
                            'icon' => 'heroicon-o-user-group',
                            'url' => fn() => \App\Filament\Pages\Housing\Rental\RentalHousingWorkersPage::getUrl(),
                            'permission' => 'housing.workers.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.available_workers',
                            'icon' => 'heroicon-o-user-plus',
                            'url' => fn() => \App\Filament\Pages\Housing\Rental\RentalHousingAvailableWorkersPage::getUrl(),
                            'permission' => 'housing.available_workers.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.requests',
                        ...
                        [
                            'title' => 'sidebar.housing.salary_batches',
                            'icon' => 'heroicon-o-banknotes',
                            'url' => fn() => \App\Filament\Resources\Housing\Rental\RentalHousingSalaryBatchResource::getUrl(),
                            'permission' => 'housing.salary_batches.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.salary_deductions',
                            'icon' => 'heroicon-o-minus-circle',
                            'url' => fn() => \App\Filament\Resources\Housing\Rental\RentalHousingSalaryDeductionResource::getUrl(),
                            'permission' => 'housing.salary_deductions.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.leaves',
                            'icon' => 'heroicon-o-calendar-days',
                            'url' => fn() => \App\Filament\Resources\Housing\Rental\RentalHousingLeaveResource::getUrl(),
                            'permission' => 'housing.leaves.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.reports',
