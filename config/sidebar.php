        ...
        [
            ...
            'children' => [
                [
                    ...
                    'icon' => 'heroicon-o-home',
                    'url' => fn() => \App\Filament\Pages\Housing\HousingDashboardPage::getUrl(),
                    'permission' => 'housing.dashboard.view',
                ],
                [
                    'title' => 'sidebar.housing.workers',
                    'icon' => 'heroicon-o-user-group',
                    'url' => fn() => \App\Filament\Pages\Housing\HousingWorkersPage::getUrl(),
                    'permission' => 'housing.workers.view_any',
                ],
                [
                    'title' => 'sidebar.housing.available_workers',
                    'icon' => 'heroicon-o-user-plus',
                    'url' => fn() => \App\Filament\Pages\Housing\HousingAvailableWorkersPage::getUrl(),
                    'permission' => 'housing.available_workers.view_any',
                ],
                [
                    'title' => 'sidebar.housing.requests',
                    'icon' => 'heroicon-o-clipboard-document-list',
                    'url' => fn() => \App\Filament\Resources\Housing\HousingRequestResource::getUrl(),
                    'permission' => 'housing.requests.view_any',
                ],
                [
                    'title' => 'sidebar.housing.salary_batches',
                    'icon' => 'heroicon-o-banknotes',
                    'url' => fn() => \App\Filament\Resources\Housing\HousingSalaryBatchResource::getUrl(),
                    'permission' => 'housing.salary_batches.view_any',
                ],
                [
                    'title' => 'sidebar.housing.salary_deductions',
                    'icon' => 'heroicon-o-minus-circle',
                    'url' => fn() => \App\Filament\Resources\Housing\HousingSalaryDeductionResource::getUrl(),
                    'permission' => 'housing.salary_deductions.view_any',
                ],
                [
                    'title' => 'sidebar.housing.leaves',
                    'icon' => 'heroicon-o-calendar-days',
                    'url' => fn() => \App\Filament\Resources\Housing\HousingLeaveResource::getUrl(),
                    'permission' => 'housing.leaves.view_any',
                ],
                [
                    'title' => 'sidebar.housing.reports',
                    'icon' => 'heroicon-o-chart-bar',
                    'url' => fn() => \App\Filament\Pages\Housing\HousingReportsPage::getUrl(),
