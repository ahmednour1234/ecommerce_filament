    ...
    'items' => [
        ...
        [
            ...
            'children' => [
                ...
                [
                    'title' => 'sidebar.housing.laborers_list',
                    'icon' => 'heroicon-o-user-group',
                    'url' => fn() => LaborerResource::getUrl(),
                    'permission' => 'laborers.view_any',
                ],
                [
                    'title' => 'sidebar.housing.status_management',
                    'icon' => 'heroicon-o-tag',
                    'url' => fn() => \App\Filament\Resources\Housing\HousingStatusResource::getUrl(),
                    'permission' => 'housing.statuses.view_any',
                ],
                [
                    'title' => 'sidebar.housing.branches_management',
                ...
                [
                    ...
                    'children' => [
                        [
                            'title' => 'sidebar.housing.available_laborers',
                            'icon' => 'heroicon-o-user-group',
                            'url' => fn() => LaborerResource::getUrl(),
                            'permission' => 'laborers.view_any',
                        ],
                        [
                            'title' => 'sidebar.housing.housing_requests',
                            'icon' => 'heroicon-o-clipboard-document-list',
                        ...
                        [
                            'title' => 'sidebar.housing.laborer_salaries',
                            'icon' => 'heroicon-o-currency-dollar',
                            'url' => fn() => \App\Filament\Pages\Housing\CreateSalaryPage::getUrl(),
                            'permission' => 'housing.salaries.create',
                        ],
                        [
                            'title' => 'sidebar.housing.laborer_leaves',
                            'icon' => 'heroicon-o-calendar',
                            'url' => fn() => \App\Filament\Pages\Housing\CreateLeavePage::getUrl(),
                        ...
                        [
                            ...
                            'children' => [
                                [
                                    'title' => 'sidebar.housing.worker_evaluations_report',
                                    'icon' => 'heroicon-o-star',
                                    'url' => fn() => \App\Filament\Pages\Housing\HousingReportsPage::getUrl(),
                                    'permission' => 'housing.reports.view',
                                ],
                                [
                                    'title' => 'sidebar.housing.worker_contracts_report',
                                    'icon' => 'heroicon-o-document-text',
                                    'url' => fn() => \App\Filament\Pages\Housing\HousingReportsPage::getUrl(),
                                    'permission' => 'housing.reports.view',
                                ],
                                [
                                    'title' => 'sidebar.housing.detailed_contracts_report',
