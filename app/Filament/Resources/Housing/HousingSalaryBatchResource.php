...
use App\Filament\Resources\Housing\HousingSalaryBatchResource\Pages;
...
class HousingSalaryBatchResource extends Resource
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.salary_batches';
