...
use App\Filament\Resources\Housing\HousingSalaryDeductionResource\Pages;
...
class HousingSalaryDeductionResource extends Resource
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.salary_deductions';
