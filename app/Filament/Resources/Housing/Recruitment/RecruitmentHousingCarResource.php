...
use App\Filament\Resources\Housing\Recruitment\RecruitmentHousingCarResource\Pages;
...
class RecruitmentHousingCarResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListRecruitmentHousingCars::route('/'),
            'create' => Pages\CreateRecruitmentHousingCar::route('/create'),
            'edit' => Pages\EditRecruitmentHousingCar::route('/{record}/edit'),
        ];
    }
