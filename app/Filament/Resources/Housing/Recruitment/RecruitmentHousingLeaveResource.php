...
use App\Filament\Resources\Housing\Recruitment\RecruitmentHousingLeaveResource\Pages;
...
class RecruitmentHousingLeaveResource extends Resource
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.recruitment_housing.leaves';
    ...
    {
        return $table
            ->query(HousingLeave::query()->where('type', 'recruitment')->with('laborer'))
            ->columns([
            ...
            ->headerActions([
                ...
                Tables\Actions\Action::make('complete_ended')
                    ...
                    ->color('success')
                    ->action(function () {
                        HousingLeave::where('type', 'recruitment')
