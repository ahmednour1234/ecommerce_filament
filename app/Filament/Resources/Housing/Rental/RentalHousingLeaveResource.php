...
use App\Filament\Resources\Housing\Rental\RentalHousingLeaveResource\Pages;
...
class RentalHousingLeaveResource extends Resource
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.rental_housing.leaves';

    public static function getEloquentQuery(): \Illuminate\Database\Eloquent\Builder
    {
        return parent::getEloquentQuery()->where('type', 'rental');
    }
    ...
    {
        return $table
            ->query(HousingLeave::query()->where('type', 'rental')->with('laborer'))
            ->columns([
            ...
            ->headerActions([
                ...
                Tables\Actions\Action::make('complete_ended')
                    ...
                    ->color('success')
                    ->action(function () {
                        HousingLeave::where('type', 'rental')
