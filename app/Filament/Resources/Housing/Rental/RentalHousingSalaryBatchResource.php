...
use App\Filament\Resources\Housing\Rental\RentalHousingSalaryBatchResource\Pages;
...
class RentalHousingSalaryBatchResource extends Resource
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.rental_housing.salary_batches';
