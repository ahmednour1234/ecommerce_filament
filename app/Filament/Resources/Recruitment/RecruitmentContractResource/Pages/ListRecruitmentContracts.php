...
class ListRecruitmentContracts extends ListRecords
{
    ...
    protected function downloadTemplate()
    {
        $headers = [
            ...
            'status' => 'STATUS (1-15) / الحالة (1=جديد, 2=موافقة السفارة الأجنبية, 3=موافقة المكتب الخارجي, 4=قبول العقد من مكتب الخارجي, 5=انتظار الابروف, 6=قبول العقد من مكتب العمل الخارجي, 7=إرسال التأشيرة إلى السفارة السعودية, 8=تم التفييز, 9=إلغاء التفييز, 10=تصريح سفر بعد تم التفييز, 11=انتظار حجز تذكرة الطيران, 12=معاد الوصول, 13=تم الاستلام, 14=رجيع خلال فترة الضمان, 15=هروب)',
