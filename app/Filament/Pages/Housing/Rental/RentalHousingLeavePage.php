...
class RentalHousingLeavePage extends Page implements HasForms
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.rental_housing.laborer_leaves';
    ...
    {
        return tr('sidebar.rental_housing.laborer_leaves', [], null, 'dashboard') ?: 'إجازات العمالة';
    }
