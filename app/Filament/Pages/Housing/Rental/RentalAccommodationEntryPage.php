...
class RentalAccommodationEntryPage extends Page implements HasForms
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.rental_housing.accommodation_entries';
    ...
    {
        return tr('sidebar.rental_housing.accommodation_entries', [], null, 'dashboard') ?: 'إدخالات الإيواء';
    }
