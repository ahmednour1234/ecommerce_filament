...
class HousingWorkersPage extends Page implements HasTable
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.workers';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('activeAssignment.status.name_ar')
                    ->label(tr('tables.housing.workers.status', [], null, 'dashboard') ?: 'الحالة')
                    ->badge()
                    ->color(fn ($record) => $record->activeAssignment?->status?->color ?? 'gray'),

                Tables\Columns\TextColumn::make('activeAssignment.building.name_ar')
