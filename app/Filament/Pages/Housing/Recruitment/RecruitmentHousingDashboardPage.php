...
class RecruitmentHousingDashboardPage extends Page implements HasForms, HasTable
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.housing.recruitment_housing.dashboard';
    ...
    {
        return tr('sidebar.housing.recruitment_housing.dashboard', [], null, 'dashboard') ?: 'لوحة تحكم قسم الإيواء';
    }
    ...
    public function getStats(): array
    {
        ...
        $stats = $service->getRequestStats($filters);
        $query = HousingRequest::recruitment();
    ...
    {
        $query = HousingRequest::recruitment()->with(['laborer']);
