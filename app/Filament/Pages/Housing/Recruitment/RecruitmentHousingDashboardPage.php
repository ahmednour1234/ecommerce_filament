...
class RecruitmentHousingDashboardPage extends Page implements HasForms
{
    ...
    protected static ?string $navigationTranslationKey = 'sidebar.recruitment_housing.dashboard';
    protected static string $view = 'filament.pages.housing.recruitment.dashboard';
    ...
    {
        return tr('sidebar.recruitment_housing.dashboard', [], null, 'dashboard') ?: 'لوحة التحكم';
    }
