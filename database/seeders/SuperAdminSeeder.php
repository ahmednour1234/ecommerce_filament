...
class SuperAdminSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        try {
            ...
            // Always run HR permissions seeders as they may have new permissions
            $this->command->info('Creating HR permissions...');
            $this->call([
                \Database\Seeders\HR\HrPermissionsSeeder::class,
            ...
            // Always run Finance permissions seeder as it may have new permissions
            $this->command->info('Creating Finance permissions...');
            $this->call([
                \Database\Seeders\Finance\FinancePermissionsSeeder::class,
            ]);

            // Always run Recruitment permissions seeders as they may have new permissions
            $this->command->info('Creating Recruitment permissions...');
            $this->call([
