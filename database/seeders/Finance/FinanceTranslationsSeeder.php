...
class FinanceTranslationsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = array_merge($translations, [
            ...
            'pages.finance.import.approve_all' => ['en' => 'Approve All Imported', 'ar' => 'اعتماد جميع المستوردة'],
            'pages.finance.import.approved_success' => ['en' => 'Approval Successful', 'ar' => 'تم الاعتماد بنجاح'],
            'pages.finance.import.approved_count' => ['en' => 'Approved :count transaction(s).', 'ar' => 'تم اعتماد :count معاملة.'],
            'pages.finance.import.approval_partial' => ['en' => 'Partial Approval', 'ar' => 'اعتماد جزئي'],
            'pages.finance.import.failed_count' => ['en' => 'Failed to approve :count transaction(s).', 'ar' => 'فشل اعتماد :count معاملة.'],
            'pages.finance.import.no_permission' => ['en' => 'Permission Denied', 'ar' => 'رفض الصلاحية'],
            'pages.finance.import.approve_permission_required' => ['en' => 'You do not have permission to approve transactions.', 'ar' => 'ليس لديك صلاحية لاعتماد المعاملات.'],
