...
class RecruitmentContractTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = [
            ...
            'recruitment_contract.fields.arrival_country' => ['en' => 'Arrival Station', 'ar' => 'محطة الوصول'],
            'recruitment_contract.arrival_station.riyadh' => ['en' => 'Riyadh', 'ar' => 'الرياض'],
            'recruitment_contract.arrival_station.dammam' => ['en' => 'Dammam', 'ar' => 'الدمام'],
            'recruitment_contract.arrival_station.jeddah' => ['en' => 'Jeddah', 'ar' => 'جده'],
            'recruitment_contract.arrival_station.taif' => ['en' => 'Taif', 'ar' => 'الطائف'],
            'recruitment_contract.arrival_station.qassim' => ['en' => 'Qassim', 'ar' => 'القصيم'],
            'recruitment_contract.arrival_station.jizan' => ['en' => 'Jizan', 'ar' => 'جيزان'],
            'recruitment_contract.arrival_station.sakaka' => ['en' => 'Sakaka', 'ar' => 'سكاكا'],
            'recruitment_contract.arrival_station.madinah' => ['en' => 'Madinah', 'ar' => 'المدينة المنورة'],
            ...
            'recruitment_contract.receiving_station.riyadh' => ['en' => 'Riyadh', 'ar' => 'الرياض'],
            'recruitment_contract.receiving_station.jeddah' => ['en' => 'Jeddah', 'ar' => 'جدة'],
            'recruitment_contract.receiving_station.makkah' => ['en' => 'Makkah', 'ar' => 'مكة المكرمة'],
            'recruitment_contract.receiving_station.madinah' => ['en' => 'Madinah', 'ar' => 'المدينة المنورة'],
            'recruitment_contract.receiving_station.dammam' => ['en' => 'Dammam', 'ar' => 'الدمام'],
            'recruitment_contract.receiving_station.khobar' => ['en' => 'Khobar', 'ar' => 'الخبر'],
            'recruitment_contract.receiving_station.taif' => ['en' => 'Taif', 'ar' => 'الطائف'],
            'recruitment_contract.receiving_station.buraydah' => ['en' => 'Buraydah', 'ar' => 'بريدة'],
            'recruitment_contract.receiving_station.tabuk' => ['en' => 'Tabuk', 'ar' => 'تبوك'],
            'recruitment_contract.receiving_station.hail' => ['en' => 'Hail', 'ar' => 'حائل'],
            'recruitment_contract.receiving_station.jazan' => ['en' => 'Jazan', 'ar' => 'جازان'],
            'recruitment_contract.receiving_station.najran' => ['en' => 'Najran', 'ar' => 'نجران'],
            'recruitment_contract.receiving_station.abha' => ['en' => 'Abha', 'ar' => 'أبها'],
            'recruitment_contract.receiving_station.sakaka' => ['en' => 'Sakaka', 'ar' => 'سكاكا'],
            'recruitment_contract.receiving_station.al_baha' => ['en' => 'Al Baha', 'ar' => 'الباحة'],
            'recruitment_contract.receiving_station.arar' => ['en' => 'Arar', 'ar' => 'عرعر'],
            'recruitment_contract.receiving_station.qatif' => ['en' => 'Qatif', 'ar' => 'القطيف'],
            'recruitment_contract.receiving_station.khafji' => ['en' => 'Khafji', 'ar' => 'الخفجي'],
            'recruitment_contract.receiving_station.yanbu' => ['en' => 'Yanbu', 'ar' => 'ينبع'],
            'recruitment_contract.receiving_station.jizan' => ['en' => 'Jizan', 'ar' => 'جيزان'],
            'recruitment_contract.receiving_station.al_qurayyat' => ['en' => 'Al Qurayyat', 'ar' => 'القريات'],
            'recruitment_contract.receiving_station.jubail' => ['en' => 'Jubail', 'ar' => 'الجبيل'],
            'recruitment_contract.receiving_station.al_rass' => ['en' => 'Al Rass', 'ar' => 'الرس'],
            'recruitment_contract.receiving_station.onaizah' => ['en' => 'Onaizah', 'ar' => 'عنيزة'],
            'recruitment_contract.receiving_station.al_zulfi' => ['en' => 'Al Zulfi', 'ar' => 'الزلفي'],
            'recruitment_contract.receiving_station.al_dawadmi' => ['en' => 'Al Dawadmi', 'ar' => 'الدوادمي'],
            'recruitment_contract.receiving_station.al_mithnab' => ['en' => 'Al Mithnab', 'ar' => 'المذنب'],
            'recruitment_contract.receiving_station.al_shamasiyah' => ['en' => 'Al Shamasiyah', 'ar' => 'الشماسية'],
            'recruitment_contract.receiving_station.al_bukayriyah' => ['en' => 'Al Bukayriyah', 'ar' => 'البكيرية'],
            'recruitment_contract.receiving_station.al_badaei' => ['en' => 'Al Badaei', 'ar' => 'البدائع'],
            ...
            'recruitment_contract.fields.marketer' => ['en' => 'Employee', 'ar' => 'اسم الموظف'],
            ...
            'recruitment_contract.visa_type.domestic_labor' => ['en' => 'Domestic Labor Visa', 'ar' => 'تأشيرة عمالة منزلية'],
            'recruitment_contract.visa_type.comprehensive_qualification' => ['en' => 'Comprehensive Qualification Visa', 'ar' => 'تأشيرة التأهيل الشامل'],

            'recruitment_contract.gender.male' => ['en' => 'Male', 'ar' => 'ذكر'],
            'recruitment_contract.gender.female' => ['en' => 'Female', 'ar' => 'أنثى'],

            'recruitment_contract.experience.unspecified' => ['en' => 'Unspecified', 'ar' => 'غير محدد'],
            'recruitment_contract.experience.new' => ['en' => 'New', 'ar' => 'جديد'],
            'recruitment_contract.experience.ex_worker' => ['en' => 'Previously Worked EX', 'ar' => 'سبق العمل EX'],

            'recruitment_contract.religion.muslim' => ['en' => 'Muslim', 'ar' => 'مسلم'],
            'recruitment_contract.religion.non_muslim' => ['en' => 'Non-Muslim', 'ar' => 'غير مسلم'],
            ...
            'recruitment_contract.status.return_during_warranty' => ['en' => 'Return During Warranty Period', 'ar' => 'رجيع خلال فتره الضمان'],
            'recruitment_contract.status.outside_kingdom_during_warranty' => ['en' => 'Outside Kingdom During Warranty Period', 'ar' => 'خارج المملكه خلال فتره الضمان'],
            'recruitment_contract.status.labor_services_transfer' => ['en' => 'Domestic Labor Services Transfer', 'ar' => 'نقل خدمات العماله المنزليه'],
            'recruitment_contract.status.runaway' => ['en' => 'Runaway', 'ar' => 'هروب'],
            'recruitment_contract.status.temporary' => ['en' => 'Temporary', 'ar' => 'مؤقته'],
