...
class RecruitmentContractTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = [
            ...
            'recruitment_contract.fields.agent' => ['en' => 'Agent', 'ar' => 'الوكيل'],
            ...
            'recruitment_contract.status.travel_permit_after_visa_issued' => ['en' => 'Travel Permit After Visa Issued', 'ar' => 'تصريح سفر بعد تم التفييز'],
