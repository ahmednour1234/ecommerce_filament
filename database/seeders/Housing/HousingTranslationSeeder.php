...
class HousingTranslationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = [
            ...
            'housing.salary_batch.print.title' => ['ar' => 'كشف رواتب العمالة', 'en' => 'Salary Batch Report'],
            'housing.salary_batch.print.date' => ['ar' => 'تاريخ الطباعة', 'en' => 'Print Date'],
            'housing.salary_batch.print.worker_name' => ['ar' => 'اسم العامل', 'en' => 'Worker Name'],
            'housing.salary_batch.print.passport' => ['ar' => 'رقم الجواز', 'en' => 'Passport Number'],
            'housing.salary_batch.print.total' => ['ar' => 'الإجمالي', 'en' => 'Total'],
            'housing.salary_batch.print.prepared_by' => ['ar' => 'أعد بواسطة', 'en' => 'Prepared By'],
            'housing.salary_batch.print.workers_count' => ['ar' => 'عدد العمالة', 'en' => 'Workers Count'],
            'housing.salary_batch.status.paid' => ['ar' => 'مدفوع', 'en' => 'Paid'],
            'housing.salary_batch.status.pending' => ['ar' => 'معلق', 'en' => 'Pending'],
            'tables.housing.salary_batch.basic_salary' => ['ar' => 'الراتب الأساسي', 'en' => 'Basic Salary'],
            'tables.housing.salary_batch.deductions' => ['ar' => 'الخصومات', 'en' => 'Deductions'],
            'tables.housing.salary_batch.net_salary' => ['ar' => 'صافي الراتب', 'en' => 'Net Salary'],
            'tables.housing.salary_batch.status' => ['ar' => 'الحالة', 'en' => 'Status'],
            ...
            'housing.salary.create' => ['ar' => 'إضافة راتب للعامل', 'en' => 'Add Salary for Employee'],
            'housing.salary.laborer' => ['ar' => 'اسم العامل', 'en' => 'Laborer Name'],
            'housing.salary.employee' => ['ar' => 'اسم العامل', 'en' => 'Employee Name'],
            'housing.salary.month' => ['ar' => 'الشهر', 'en' => 'Month'],
            'housing.salary.basic_salary' => ['ar' => 'الراتب الأساسي', 'en' => 'Basic Salary'],
            'housing.salary.overtime_hours' => ['ar' => 'ساعات العمل الإضافي', 'en' => 'Overtime Hours'],
            'housing.salary.overtime_amount' => ['ar' => 'مبلغ العمل الإضافي', 'en' => 'Overtime Amount'],
            'housing.salary.bonuses' => ['ar' => 'المكافآت', 'en' => 'Bonuses'],
            'housing.salary.deductions' => ['ar' => 'إجمالي الخصومات', 'en' => 'Total Deductions'],
            'housing.salary.deductions_helper' => ['ar' => 'سيتم حسابها تلقائياً من الخصومات المحددة', 'en' => 'Will be calculated automatically from specified deductions'],
            'housing.salary.net_salary' => ['ar' => 'الراتب الصافي', 'en' => 'Net Salary'],
            'housing.salary.notes' => ['ar' => 'ملاحظات', 'en' => 'Notes'],
