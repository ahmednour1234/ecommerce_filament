...
class HousingTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = [
            ...
            'housing.status.unpaid_salary' => ['en' => 'Unpaid Salary', 'ar' => 'عدم دفع راتب'],
            'housing.status.transfer_sponsorship' => ['en' => 'Sponsorship Transfer', 'ar' => 'نقل كفاله'],
            'housing.status.temporary' => ['en' => 'Temporary', 'ar' => 'مؤقته'],
            'housing.status.rental' => ['en' => 'Rental', 'ar' => 'ايجار'],
            'housing.status.work_refused' => ['en' => 'Work Refused', 'ar' => 'رفض عمل'],
            ...
            'housing.status.in_accommodation' => ['en' => 'In Accommodation', 'ar' => 'في الايواء'],
            'housing.status.outside_kingdom' => ['en' => 'Outside Kingdom', 'ar' => 'خارج المملكه'],
            'housing.status.ready_for_travel' => ['en' => 'Ready for Travel', 'ar' => 'جاهزه للتسفير'],
