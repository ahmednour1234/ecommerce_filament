...
class RentalTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = array_merge($translations, [
            ...
            'rental.contracts.pricing' => ['en' => 'Pricing', 'ar' => 'سعر العقد'],
            ...
            'rental.fields.amount'         => ['en' => 'Amount', 'ar' => 'المبلغ'],
        ...
        $translations = array_merge($translations, [
            ...
            'rental.requests.stats.awaiting_approval' => ['en' => 'Contracts Awaiting Approval', 'ar' => 'عقود قيد الموافقة'],
            'rental.requests.stats.awaiting_approval_desc' => ['en' => 'Contracts Awaiting Approval', 'ar' => 'عقود قيد الموافقة'],
            'rental.requests.stats.approved' => ['en' => 'Approved', 'ar' => 'موافق عليه'],
            'rental.requests.stats.approved_desc' => ['en' => 'Approved', 'ar' => 'موافق عليه'],
            'rental.requests.stats.rejected' => ['en' => 'Rejected', 'ar' => 'مرفوض'],
            'rental.requests.stats.rejected_desc' => ['en' => 'Rejected', 'ar' => 'مرفوض'],
            'rental.requests.stats.active_contracts' => ['en' => 'Active Rental Contracts', 'ar' => 'عقود التأجير النشطة'],
            'rental.requests.stats.active_contracts_desc' => ['en' => 'Active Rental Contracts', 'ar' => 'عقود التأجير النشطة'],
            'rental.requests.stats.inactive_contracts' => ['en' => 'Inactive Rental Contracts', 'ar' => 'عقود التأجير غير النشطة'],
            'rental.requests.stats.inactive_contracts_desc' => ['en' => 'Inactive Rental Contracts', 'ar' => 'عقود التأجير غير النشطة'],
        ...
        $translations = array_merge($translations, [
            ...
            'rental.reports.returned_contracts' => ['en' => 'Returned Contracts', 'ar' => 'العقود المسترجعة'],
            'rental.reports.cancelled_contracts' => ['en' => 'Cancelled Contracts', 'ar' => 'العقود الملغاة'],
            'rental.reports.archived_contracts' => ['en' => 'Archived Contracts', 'ar' => 'العقود المؤرشفة'],
            'rental.reports.cancel_refund_requests' => ['en' => 'Cancel/Refund Requests', 'ar' => 'طلبات الإلغاء والاسترجاع'],
            'rental.reports.click_to_view' => ['en' => 'Click to view', 'ar' => 'انقر للعرض'],
