...
class RunRentalPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $superAdminRole = Role::where('name', 'super_admin')->orWhere('name', 'Super Admin')->first();
        if ($superAdminRole) {
            $superAdminRole->givePermissionTo($allPermissions);
            $this->command->info('✓ All rental permissions assigned to ' . $superAdminRole->name . ' role');
        } else {
    ...
    echo "\n═══════════════════════════════════════════════════════\n";
    echo "✓ Rental permissions seeder completed successfully!\n";
    echo "═══════════════════════════════════════════════════════\n";
