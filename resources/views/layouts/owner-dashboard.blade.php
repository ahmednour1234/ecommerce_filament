...
<div class="flex min-h-screen">
    ...
    <aside class="sidebar fixed top-0 right-0 bottom-0 flex flex-col z-40 overflow-y-auto">
        ...
        <nav class="flex-1 px-3 py-4">
            ...
            <a href="{{ url('/admin/recruitment-contracts') }}" class="nav-item">
            ...
            <a href="{{ url('/admin/employees') }}" class="nav-item">
            ...
            <a href="{{ url('/admin/rental-contracts') }}" class="nav-item">
            ...
            <a href="{{ url('/admin/journal-entries') }}" class="nav-item">
            ...
            <a href="{{ url('/admin/branches') }}" class="nav-item">
