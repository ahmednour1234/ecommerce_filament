...
<body>
    ...
    <div class="summary-section">
        <h2>{{ trans_dash('reports.expense.summary.title', 'Summary') }}</h2>
        
        @if(isset($metadata['total_expenses']) || isset($metadata['transaction_count']))
        <div class="summary-stats">
            @if(isset($metadata['total_expenses']))
            <div class="summary-stat">
                <div class="summary-stat-label">{{ trans_dash('reports.expense.summary.total_expenses', 'Total Expenses') }}</div>
                <div class="summary-stat-value">{{ $metadata['total_expenses'] ?? '0.00' }}</div>
            </div>
            @endif
            @if(isset($metadata['transaction_count']))
            <div class="summary-stat">
                <div class="summary-stat-label">{{ trans_dash('reports.expense.summary.transaction_count', 'Transaction Count') }}</div>
    ...
    <div style="margin-top: 20px;">
        <h2 style="font-size: 14px; font-weight: bold; margin-bottom: 10px; text-align: {{ $isRtl ?? (app()->getLocale() === 'ar') ? 'right' : 'left' }};">
            {{ trans_dash('reports.expense.detailed_transactions', 'Detailed Transactions') }}
        </h2>
        <table>
            <thead>
                <tr>
