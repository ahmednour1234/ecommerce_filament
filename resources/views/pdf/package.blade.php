...
<body>
    ...
    <div class="cost-summary">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>{{ number_format($package->base_price ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($package->external_costs ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($package->worker_salary ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($package->gov_fees ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($package->tax_percent ?? 0, 2) }}%</td>
                    <td>{{ number_format($package->tax_value ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td class="total-row">{{ number_format($package->total ?? 0, 2) }} {{ 'SAR' }}</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ number_format($detail->direct_cost ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($detail->gov_cost ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($detail->external_cost ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td>{{ number_format($detail->tax_percent ?? 0, 2) }}%</td>
                    <td>{{ number_format($detail->tax_value ?? 0, 2) }} {{ 'SAR' }}</td>
                    <td class="total-row">{{ number_format($detail->total_with_tax ?? 0, 2) }} {{ 'SAR' }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
